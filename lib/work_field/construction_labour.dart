...
class ConstructionLabourPage extends StatefulWidget {
  const ConstructionLabourPage({Key? key}) : super(key: key);

  @override
  _ConstructionLabourPageState createState() => _ConstructionLabourPageState();
}

class _ConstructionLabourPageState extends State<ConstructionLabourPage> {
  ...
  String selectedTask = 'carrying materials';
    ...
    return Theme(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            'Enter Construction Labour Details ',
            style: TextStyle(
              color: Colors.black,
              fontSize: 20.0,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: [
                        DropdownMenuItem(
                          value: 'carrying materials',
                          child: Text('Carrying Materials'),
                        ),
                        DropdownMenuItem(
                          value: 'site clean-up',
                          child: Text('Site Clean-up'),
                        ),
                        DropdownMenuItem(
                          value: 'Mistari',
                          child: Text('Mistari'),
