...
class genralLabourPage extends StatefulWidget {
  const genralLabourPage({Key? key}) : super(key: key);

  @override
  _genralLabourPage createState() => _genralLabourPage();
}

class _genralLabourPage extends State<genralLabourPage> {
  ...
  String selectedTask = 'Genral Work';
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: [
                        DropdownMenuItem(
                          value: 'Genral Work',
                          child: Text('Genral Work'),
                        ),
                        DropdownMenuItem(
                          value: 'moving furniture',
                          child: Text('Moving Furniture'),
                        ),
                        DropdownMenuItem(
                          value: 'loading/unloading trucks',
                          child: Text('Loading/Unloading Trucks'),
                        ),
                        DropdownMenuItem(
                          value: 'cleaning',
                          child: Text('Cleaning'),
