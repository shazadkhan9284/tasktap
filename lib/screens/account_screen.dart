import 'package:catalog/screens/profile_screen.dart';
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Row(
                  ...
                  children: [
                    ...
                    Image.asset(
                      'images/ttlogo.png', // Replace 'your_image.png' with the path to your image
              ...
              GestureDetector(
                onTap: () {
                  //Navigator.push(context, MaterialPageRoute(builder: (c) => ReferForm()));
                },
                child: Container(
                  padding: EdgeInsets.all(10),
                  decoration: BoxDecoration(
